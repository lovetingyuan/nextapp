 ...
 */
const multiSelectVariants = cva('m-1  hover:border-primary', {
  variants: {
    variant: {
                  ...
                  {selectedValues.slice(0, maxCount).map(value => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className={`truncate ${selectedTextClassName}`}>{option?.label}</span>
                        <span
                          onClick={event => {
                        ...
                        >
                          <XCircle className="w-4 h-4 hover:scale-125 cursor-pointer" />
                        </span>
                      </Badge>
                    )
                  })}
